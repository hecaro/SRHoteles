...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf8_spanish_ci">
	...
	<title>PORCENTAJE DE OCUPACION - SRHoteles</title>
	<style type="text/css">   
	a:link   
	{   
...
<body>
	...
	<div class="Titulo">
		...
		<h1 class="FR">PORCENTAJE DE OCUPACION</h1>
	<div class="CuadroExt">
	...
	<form action="../../Backend/PHP/reporteporcentaje.php" target="_blank" method="post">
