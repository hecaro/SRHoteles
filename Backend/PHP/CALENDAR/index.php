...
$sql = "SELECT  id, title, start, end, color  FROM events  WHERE razonsocial = '$usuario' ";
...
<head>
    ...
    <title>Calendario - SRHoteles</title>
		...
		<header class="BarraMenu" id="CabeceraPrincipal">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    <li>
                        <!--<a href="../../../Frontend/HTML/MenuAdminHotel.php">Menu</a>-->
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1>Calendario</h1>
                <p class="lead">Calendario - SRHoteles</p>
